    ...
    <div className="min-h-screen bg-black text-white selection:bg-purple-500 selection:text-white">
      ...
      <section id="projects" className="py-24 px-4 max-w-5xl mx-auto">
        ...
        <div className="space-y-24">
          ...
          {/* Project 1: Medical Data Assistant */}
      ...
      <footer id="contact" className="py-20 border-t border-white/10 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <div className="mt-16 flex justify-center space-x-8 text-gray-500">
            <a href="https://github.com/sanket2401" target="_blank" className="hover:text-white transition">GitHub</a>
            <a href="https://www.linkedin.com/in/sanket-jadhav-s242001" target="_blank" className="hover:text-white transition">LinkedIn</a>
          </div>
